Shader "Custom/CelGlass"
{
    ...
    SubShader{
        ...
        void surf(Input IN, inout SurfaceOutput o) {
            ...
            // basing on normal and light direction and view direction       
            half lightDot = dot(o.Normal, lightDirection -IN.viewDir)*0.5 + _SpecOffset; 
            ...
            // make it glow
            // fresnel rim
            o.Emission = _RimColor.rgb * pow(outerrim, 1.5); 
            // inner glow fresnel
            o.Emission += _RimColor2.rgb * pow(innerglow, 1.5); 
    
            // view specular
            half viewSpec =  saturate(dot(o.Normal, (IN.viewDir))); 
            // basing on normal and light direction
